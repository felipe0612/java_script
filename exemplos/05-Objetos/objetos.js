...
let celebridade  = {
    ...
    idade: 37,
    sexo: 'feminino',
    filmes: ['Lost in translation','The Avengers','Marrige Story'],
    cidade: 'Nova york',
    medidas: {
    peso: 57,
    altura: 1.60
...
document.write(`<strong>${celebridade.nome}</strong> é uma atriz incrível,assita o filme: <strong>${celebridade.filmes[2]}</strong>.<br>`);
